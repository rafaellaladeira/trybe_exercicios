...
// Pq o botão de "alterar a primeira tecnologia" 'empurrou' ela pra cima devido às suas alterações no CSS.

// 2. Crie uma função que adicione a classe 'tech' ao elemento `li` quando for clicado.
// 2.1. Deve existir apenas um elemento com a classe 'tech'. Como você faz isso?

/* declarar a variavel para mexer 
remover a class tech do li que tem essa classe
linha do event.target para adicionar a classe
...
input.addEventListener('input' , digit);
...
myWebpage.addEventListener('mouseover', function () {
    const color = document.getElementById('.my-spotrybefy')[0];
